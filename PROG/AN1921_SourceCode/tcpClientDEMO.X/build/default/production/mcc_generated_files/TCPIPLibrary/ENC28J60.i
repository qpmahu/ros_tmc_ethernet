...
# 18 "C:/Program Files (x86)/Microchip/MPLABXv540/packs/Microchip/PIC16F1xxxx_DFP/1.4.119/xc8\pic\include\xc.h"
...
# 52 "C:/Program Files (x86)/Microchip/MPLABXv540/packs/Microchip/PIC16F1xxxx_DFP/1.4.119/xc8\pic\include\proc\pic16f18346.h"
...
# 30 "C:/Program Files (x86)/Microchip/MPLABXv540/packs/Microchip/PIC16F1xxxx_DFP/1.4.119/xc8\pic\include\pic.h"
...
# 114 "C:/Program Files (x86)/Microchip/MPLABXv540/packs/Microchip/PIC16F1xxxx_DFP/1.4.119/xc8\pic\include\eeprom_routines.h"
extern void eeprom_write(unsigned char addr, unsigned char value);
extern unsigned char eeprom_read(unsigned char addr);


# 91 "C:/Program Files (x86)/Microchip/MPLABXv540/packs/Microchip/PIC16F1xxxx_DFP/1.4.119/xc8\pic\include\pic.h"
...
# 160 "mcc_generated_files/TCPIPLibrary/../pin_manager.h"
...
# 116 "mcc_generated_files/TCPIPLibrary/../spi1.h"
...
# 58 "mcc_generated_files/TCPIPLibrary/../TCPIPLibrary/network.h"
...
# 71 "mcc_generated_files/TCPIPLibrary/../adc.h"
...
# 100 "mcc_generated_files/TCPIPLibrary/../tmr1.h"
...
# 72 "mcc_generated_files/TCPIPLibrary/../mcc.h"
...
# 61 "mcc_generated_files/TCPIPLibrary/ENC28J60.c"
...
do{LATC6 = 0;} while(0);
SPI1_Exchange8bit(bfc_inst | 0x1F);
...
do{LATC6 = 0;} while(0);
SPI1_Exchange8bit(bfs_inst | 0x1F);
SPI1_Exchange8bit(a >> 6);
do{LATC6 = 1;} while(0);
}
}
...
do{LATC6 = 0;} while(0);
SPI1_Exchange8bit(rbm_inst);
((char *) &nextPacketPointer)[0] = SPI1_Exchange8bit(0);
((char *) &nextPacketPointer)[1] = SPI1_Exchange8bit(0);
((char *) &rxPacketStatusVector)[0] = SPI1_Exchange8bit(0);
((char *) &rxPacketStatusVector)[1] = SPI1_Exchange8bit(0);
((char *) &rxPacketStatusVector)[2] = SPI1_Exchange8bit(0);
((char *) &rxPacketStatusVector)[3] = SPI1_Exchange8bit(0);
do{LATC6 = 1;} while(0);
...
ENC28_BankSel(a);
do{LATC6 = 0;} while(0);
SPI1_Exchange8bit(rcr_inst | (a & 0x1F));
v = SPI1_Exchange8bit(0);
do{LATC6 = 1;} while(0);
...
a &= 0x1F;
do{LATC6 = 0;} while(0);
SPI1_Exchange8bit(rcr_inst | (a));
((char *) &v)[0] = SPI1_Exchange8bit(0);
do{LATC6 = 1;} while(0);
__nop();
__nop();
do{LATC6 = 0;} while(0);
SPI1_Exchange8bit(rcr_inst | (a + 1));
((char *) &v)[1] = SPI1_Exchange8bit(0);
do{LATC6 = 1;} while(0);
...
ENC28_BankSel(a);
do{LATC6 = 0;} while(0);
SPI1_Exchange8bit(wcr_inst | (a & 0x1F));
SPI1_Exchange8bit(v);
do{LATC6 = 1;} while(0);
}
...
a &= 0x1F;
do{LATC6 = 0;} while(0);
SPI1_Exchange8bit(wcr_inst | (a));
SPI1_Exchange8bit(((char *) &v)[0]);
do{LATC6 = 1;} while(0);
__nop();
__nop();
do{LATC6 = 0;} while(0);
SPI1_Exchange8bit(wcr_inst | (a + 1));
SPI1_Exchange8bit(((char *) &v)[1]);
do{LATC6 = 1;} while(0);
}
...
ENC28_BankSel(a);
do{LATC6 = 0;} while(0);
SPI1_Exchange8bit(bfs_inst | (a & 0x1F));
SPI1_Exchange8bit(bits);
do{LATC6 = 1;} while(0);
}
...
ENC28_BankSel(a);
do{LATC6 = 0;} while(0);
SPI1_Exchange8bit(bfc_inst | (a & 0x1F));
SPI1_Exchange8bit(bits);
do{LATC6 = 1;} while(0);
}
...
do{LATC6 = 0;} while(0);
SPI1_Exchange8bit(rbm_inst);
((char *) &b)[2] = SPI1_Exchange8bit(0);
((char *) &b)[1] = SPI1_Exchange8bit(0);
((char *) &b)[0] = SPI1_Exchange8bit(0);
do{LATC6 = 1;} while(0);
...
do{LATC6 = 0;} while(0);
SPI1_Exchange8bit(rbm_inst);
while (length--) *p++ = SPI1_Exchange8bit(0);
do{LATC6 = 1;} while(0);
...
do{LATC6 = 0;} while(0);
SPI1_Exchange8bit(wbm_inst);
SPI1_Exchange8bit(Control_Byte);
SPI1_Exchange8bit(dest_mac->mac_array[0]);
SPI1_Exchange8bit(dest_mac->mac_array[1]);
SPI1_Exchange8bit(dest_mac->mac_array[2]);
SPI1_Exchange8bit(dest_mac->mac_array[3]);
SPI1_Exchange8bit(dest_mac->mac_array[4]);
SPI1_Exchange8bit(dest_mac->mac_array[5]);
SPI1_Exchange8bit(eth_MAC->mac_array[0]);
SPI1_Exchange8bit(eth_MAC->mac_array[1]);
SPI1_Exchange8bit(eth_MAC->mac_array[2]);
SPI1_Exchange8bit(eth_MAC->mac_array[3]);
SPI1_Exchange8bit(eth_MAC->mac_array[4]);
SPI1_Exchange8bit(eth_MAC->mac_array[5]);
SPI1_Exchange8bit(type >> 8);
SPI1_Exchange8bit(type & 0x0FF);
do{LATC6 = 1;} while(0);
TXPacketSize += 15;
